...
| `03/13 - 03/17` | [L: program analysis 1][lec08]        | [L: program analysis 1][lec08]          | [L: program analysis 2][lec09]                                                | [L: program analysis 2][lec09]                                   | Quiz 1                                                                             |
| `03/20 - 03/24` | [L: loop optimization][lec10]         | [L: loop optimization][lec10]           | [L: register allocation][lec11]                                               | [L: register allocation][lec11]                                  | [L: register allocation][lec11]                                                    |
| `03/27 - 03/31` | Spring Break                          | Spring Break                            | Spring Break                                                                  | Spring Break                                                     | Spring Break                                                                       |
| `04/03 - 04/07` | [L: parallelization][lec12]           | [L: parallelization][lec12]             | __P3 DUE @ 6:00PM__ <br/> [P4 RELEASE][P4 RELEASE] <br/> [L: dataflow][lec13] | [L: dataflow][lec13]                                             | [L: dataflow][lec13]                                                               |
| `04/10 - 04/14` | [L: dataflow][lec13]                  | [L: memory opt][lec14]                  | [L: memory opt][lec14]                                                        | [L: memory opt][lec14]                                           | [L: memory opt][lec14]                                                             |
| `04/17 - 04/21` | Patriots' Day Holiday                 |                                         |                                                                               |                                                                  | __P4 DUE @ 6:00PM__<br/>[P5 RELEASE][P5 RELEASE]<br/>                              |
