...
The writeup serves as a status report and an opportunity to communicate issues to the TAs. Include the following information:
...
In future phases, the writeup will also serve as a design document help us understand and grade your submissions. Note that you will need to submit more documentation about this phase later, in the phase 3 writeup.
...
Use the same procedure as in [phase 1](../phase-1/README.md#submission) to submit, but this time to the branch `phase2-submission`. Keep in mind that the tests passed on the grading server do not represent the final score for the project.
